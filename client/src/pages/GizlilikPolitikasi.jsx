        ...
        <div className="bg-[#16181D] border border-[#2A2D35] rounded-xl p-8 sm:p-12 shadow-2xl">
          ...
          <div className="space-y-8 text-[#A0A5B5] leading-relaxed text-[15px]">
            <section>
              ...
              <p>
                Emlak Asistanı olarak, yalnızca size daha iyi bir hizmet sunabilmek ve platformun temel CRM işlevlerini yerine getirebilmek için gerekli olan minimum veriyi toplarız. Bunlar, platforma kayıt olurken verdiğiniz profil bilgileriniz ile sisteme eklediğiniz müşteri (lead) kayıtlarından ibarettir.
              </p>
            </section>
